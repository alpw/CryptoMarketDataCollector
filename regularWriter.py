...
# all coins ---USDT--- parity.
binanceTethers = ['AXS', 'BCH', 'ALGO', 'STRAX', 'RLC', 'GTO', 'ZEN', 'QTUM', 'BAND', 'BNT', 'KNC', 'THETA', 'STORJ', 
'BAT', 'KSM', 'BEL', 'NBS', 'TFUEL', 'UNFI', 'ANKR', 'DREP', 'CTSI', 'IOST', 'STX', 'NEAR', 'CRV', 'KMD', 'LRC', 'FTM', 
'EOS', 'ONE', 'RVN', 'ETH', 'MKR', 'FIL', 'AION', 'WAN', 'OGN', 'XEM', 'AVAX', 'YFI', 'STMX', 'BNB', 'MITH', 'DGB', 
'OMG', 'ARPA', 'CTK', 'ZEC', 'BLZ', 'AVA', 'HBAR', 'SUSHI', 'ASR', 'REN', 'OXT', 'LTC', 'DIA', 'HNT', 'PERL', 'WTC', 
'TCT', 'SAND', 'MANA', 'FIO', 'BEAM', 'UTK', 'DOCK', 'LUNA', 'BZRX', 'REEF', 'OCEAN', 'UNI', 'XRP', 'IRIS', 'TOMO', 
'AKRO', 'SNX', 'GXS', 'SXP', 'ATOM', 'XLM', 'CHZ', 'AAVE', 'ORN', 'DASH', 'BAL', 'FTT', 'NULS', 'CHR', 'LSK', 'SOL', 
'ENJ', 'ZRX', 'VITE', 'WRX', 'OG', 'NEO', 'COS', 'ONT', 'NANO', 'DUSK', 'ANT', 'FLM', 'WING', 'YFII', 'ROSE', 'NMR', 
'SC', 'AUDIO', 'CTXC', 'CVC', 'SUSD', '1INCH', 'ONG', 'FUN', 'LINK', 'ATM', 'BTS', 'ETC', 'GRT', 'DOGE', 'NKN', 'PSG', 
'ADA', 'ZIL', 'KAVA', 'ARDR', 'EGLD', 'XVS', 'MATIC', 'DNT', 'RSR', 'RIF', 'UMA', 'DOT', 'TROY', 'CELR', 'FET', 'TRX', 
'STPT', 'HIVE', 'XTZ', 'PNT', 'VET', 'CELO', 'JST', 'SUN', 'DCR', 'XMR', 'WAVES', 'IOTX', 'COTI', 'MDT', 'SKL', 'HARD', 
'REP', 'JUV', 'LTO', 'RUNE', 'ALPHA', 'INJ', 'ICX', 'COMP', 'TRB', 'MTL', 'SRM'] # I got this using another codes written by me.
...
con = sqlite3.connect("data_{}.db".format(time))
cursor = con.cursor()
...
while True:
    for coinName in binanceTethers:
        ...
        fetchBook = exchange.fetch_order_book("{}/USDT".format(coinName))
        ...
        print(coinName, "{} values written on the SQL".format(len(values)))
